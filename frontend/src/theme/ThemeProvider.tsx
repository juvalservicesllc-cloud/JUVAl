...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    root.style.setProperty("--surface-raised", settings.appearanceMode === "dark" ? "#20232b" : "#eef1f6")
    root.style.setProperty("--surface-hover", settings.appearanceMode === "dark" ? "#262a33" : "#e7ebf2")
